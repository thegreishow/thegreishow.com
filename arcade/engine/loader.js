...
function card(game){
  ...
  el.querySelector('img')?.addEventListener('error',e=>{
    ...
    image.src='arcade/assets/thumbnails/template.svg';
    image.alt=`${game.title} artwork unavailable`;
  });
  return el;
}
