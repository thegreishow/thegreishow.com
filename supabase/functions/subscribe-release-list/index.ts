...
function welcomeHtml(greeting: string) {
  return `<!DOCTYPE html><html><body style="margin:0;background:#03060c"><table width="100%" cellpadding="0" cellspacing="0" bgcolor="#03060c"><tr><td align="center" style="padding:32px 16px"><table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#0b111b;border-radius:16px"><tr><td style="padding:36px 32px 12px;font:700 12px Arial;color:#d8ff63;letter-spacing:2px">THE GREI SHOW</td></tr><tr><td style="padding:4px 32px 12px;font:700 32px/40px Arial;color:#f5f7fb">Welcome to the signal.</td></tr><tr><td style="padding:4px 32px 12px;font:16px/27px Arial;color:#d7dee8">Hello ${greeting},</td></tr><tr><td style="padding:0 32px 18px;font:16px/27px Arial;color:#d7dee8">You are now on the official release list for new music, stories, visuals, live moments and playable experiments from The Grei Show.</td></tr><tr><td style="padding:8px 32px 24px"><a href="https://thegreishow.com" style="display:inline-block;background:#d8ff63;border-radius:999px;padding:13px 22px;font:700 15px Arial;color:#03060c;text-decoration:none">Enter The Grei Show</a></td></tr><tr><td style="padding:4px 32px 32px;font:13px/21px Arial;color:#91a0b3">Independent music, stories and creative worlds from Jamaica.<br>Reply to this email anytime.</td></tr></table></td></tr></table></body></html>`;
}
